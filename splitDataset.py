...
# python splitDataset.py --dataset_dir "/Users/pranav/Desktop/LNN/TACO Stuff/data" --test_percentage 10 --val_percentage 10 --nr_trials 10
parser = argparse.ArgumentParser(description='User args')
parser.add_argument('--dataset_dir', default=os.path.join(os.path.expanduser("~"), "Desktop/LNN/TACO Stuff/data"), required=True, help='Path to dataset annotations')
...
#
#     # Add new datasets
#     train_set = {'info': dataset['info'], 'images': [], 'annotations': [], 'scene_annotations': [], 'licenses': [], 'categories': dataset['categories'], 'scene_categories': dataset['scene_categories']}
#
